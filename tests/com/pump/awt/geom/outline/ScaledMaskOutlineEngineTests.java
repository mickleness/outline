...
//        };
//
//        LazyOperationOutline outline_expected = new LazyOperationOutline(new ScaledMaskOutlineEngine(4));
//        LazyOperationOutline outline_actual = new LazyOperationOutline(new ScaledMaskOutlineEngine(4));
