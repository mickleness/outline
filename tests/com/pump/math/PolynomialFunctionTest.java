...
public class PolynomialFunctionTest extends TestCase {
    ...
    public void testNoSolutionsQuadratic() {
        ...
        assertEquals(0, f.evaluateInverse(-1, new double[3]));
        assertEquals(1, f.evaluateInverse(0, new double[3]));
        assertEquals(2, f.evaluateInverse(1, new double[3]));
    }
    ...
    public void testDegenerateCubic_1() {
        ...
        int solutionCount = f.solve(solutions);
